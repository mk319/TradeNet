Create a simple Model-View-Controller GUI application to show the following quote fields for a published ticker system (universe of symbols: FB, AAPL, GOOG, MSFT, CRM, TWTR, BABA, SPY, QQQ, DIA) 
